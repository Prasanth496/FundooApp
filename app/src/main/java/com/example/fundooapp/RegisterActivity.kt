        ...
        buttonRegister?.setOnClickListener(object : View.OnClickListener {
            override fun onClick(view: View?) {
                if (validate()) {
                    ...
                    if (databaseHelper!!.isEmailExists()) { //Email does not exist now add new user to database
                        databaseHelper!!.addUser(User(null, UserName, Email, Password))
                        buttonRegister?.let {
                            Snackbar.make(
                                it,
                        ...
                        Handler().postDelayed(Runnable { finish() }, Snackbar.LENGTH_LONG.toLong())
